...
MapPrefab::MapPrefab()
{
	...
	//AddChild(new BuildingPrefab{ L"Meshes/Buildings/Model_1", pMaterial, pDefaultMaterial, XMFLOAT3{20,0,0}, XMFLOAT3{} });
	//AddChild(new BuildingPrefab{ L"Meshes/Buildings/Model_2", pMaterial, pDefaultMaterial, XMFLOAT3{-20,0,0}, XMFLOAT3{} });
	//AddChild(new BuildingPrefab{ L"Meshes/Buildings/Model_3", pMaterial, pDefaultMaterial, XMFLOAT3{-40,0,0}, XMFLOAT3{} });
...
{
	const auto groundPlane = new CubePrefab{ size.x,size.y,size.z, XMFLOAT4{Colors::White} };
